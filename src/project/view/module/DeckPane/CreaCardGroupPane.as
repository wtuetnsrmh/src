package project.view.module.DeckPane 
{
	...
	import project.view.ui.CustomScroll;
	 ...
	 * @author bbjxl 2012
	 */
	public class CreaCardGroupPane extends BaseTitleWindow
	{
		...
		//--------------------------------------------------------
		private var _editCG:MovieClipButton;//编辑卡组
		private var _cancelCG:MovieClipButton;//解除卡组
		private var _closeBt:MovieClipButton;//关闭
		//--------------------------------------------------------
