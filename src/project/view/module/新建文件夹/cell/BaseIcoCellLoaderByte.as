package project.view.module.cell
{
	...
	*/
    ...
    public class BaseIcoCellLoaderByte extends BaseSpritePane
    {
        ...
        public function BaseIcoCellLoaderByte()
        {
        ...
        public function set ico(param1) : void
        {
            ...
            if (param1 is String)
            {
                try
                {
                    ...
                    //this._urlLoader.load(new URLRequest(param1), lc);
        ...
        {
            /*var dio : DisplayObject = event.target.content;
            ...
            addChild(bmp);*/
			 ...
			 this.setImgIco(_loader.content);
            this._icoImg = _loader.content;
