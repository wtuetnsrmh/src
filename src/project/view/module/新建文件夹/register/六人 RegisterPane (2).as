package project.view.module.register
{
	...
	*/
    ...
    public class RegisterPane extends BaseTitleWindow
    {
		...
		private var _heroMc3:MovieClip;//选择的种族对应的英雄上半身
		private var _heroMc4:MovieClip;//选择的种族对应的英雄上半身
		private var _heroMc5:MovieClip;//选择的种族对应的英雄上半身
		private var _heroMc6:MovieClip;//选择的种族对应的英雄上半身
        ...
        private function configerUIInstance() : void
        {
			...
			_heroMc3 = _secen2["heroMc3"] as MovieClip;
			_heroMc4 = _secen2["heroMc4"] as MovieClip;
			_heroMc5 = _secen2["heroMc5"] as MovieClip;
			_heroMc6 = _secen2["heroMc6"] as MovieClip;
			bodys = [_heroMc1, _heroMc2, _heroMc3, _heroMc4, _heroMc5, _heroMc6];
		...
		private function showInfoByRace(raceId:int, lr:String = "left"):void {
			...
			switch(raceId) {
				case 1:
					var nordicId:String;
					if (lr == "left") {
						bodyIndex = (_currentSelectedRace-1) * 2 + 1;
						...
						this._introText.htmlText = LocalConfig.LOCAL_LAN.RegisterPane.nordicLeft.@Desc;
							...
							bodyIndex = (_currentSelectedRace-1) * 2 + 2;
							//_heroMc.gotoAndStop((_currentSelectedRace-1) * 2 + 2);//2.4.6
		...
		private var centerArr:Array= [[285, 230], [285, 230], [285, 230], [285, 230],[285, 230], [285, 230]];
		...
		private function initSecen2():void {
			...
			//_heroMc.gotoAndStop((_currentSelectedRace-1) * 2 + 1);//1.3.5
			bodyIndex = (_currentSelectedRace-1) * 2 + 1;
			/*var _loc_7:MovieClip = bodys[bodyIndex];
			curRole = tarRole;
			tarRole = _loc_7;
			startRippler();*/
