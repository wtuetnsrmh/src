package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName16 extends SkillBase
	{
		
		
		public function skillName16(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			var snow:MovieClip;
				...
				snow = new MovieClip(_textureAils.getTextures("加速16"),_frame);
				_textureAils=null;
