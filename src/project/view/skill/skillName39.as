package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName39 extends SkillBase
	{
		
		
		public function skillName39(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			snow = new MovieClip(_textureAils.getTextures("饮血斩39"),_frame);
			_textureAils=null;
