package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName20 extends SkillBase
	{
		
		
		public function skillName20(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			var snow:MovieClip;
				...
				snow = new MovieClip(_textureAils.getTextures("灵魂炸裂20"),_frame);
				_textureAils=null;
