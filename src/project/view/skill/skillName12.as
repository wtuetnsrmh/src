package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName12 extends SkillBase
	{
		
		
		public function skillName12(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			var snow:MovieClip;
				...
				snow = new MovieClip(_textureAils.getTextures("攻击力下降12"),_frame);
				_textureAils=null;
