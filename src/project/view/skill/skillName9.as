package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName9 extends SkillBase
	{
		
		
		public function skillName9(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			var snow:MovieClip;
				...
				snow = new MovieClip(_textureAils.getTextures("病毒侵蚀9"),_frame);
				_textureAils=null;
