package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName31 extends SkillBase
	{
		
		
		public function skillName31(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			snow = new MovieClip(_textureAils.getTextures("死灵能量31_"),_frame);
			_textureAils=null;
