package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName33 extends SkillBase
	{
		
		
		public function skillName33(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			snow = new MovieClip(_textureAils.getTextures("体力上升33"),_frame);
			_textureAils=null;
			addChild(snow);
