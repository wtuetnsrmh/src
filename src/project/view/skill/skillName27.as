package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName27 extends SkillBase
	{
		
		
		public function skillName27(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			var snow:MovieClip;
				...
				snow = new MovieClip(_textureAils.getTextures("暴风强踢27"),_frame);
				_textureAils=null;
