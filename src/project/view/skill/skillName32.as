package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName32 extends SkillBase
	{
		
		
		public function skillName32(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			snow = new MovieClip(_textureAils.getTextures("泰坦附32"),_frame);
			_textureAils=null;
