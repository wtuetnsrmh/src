package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName19 extends SkillBase
	{
		
		
		public function skillName19(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			var snow:MovieClip;
				...
				snow = new MovieClip(_textureAils.getTextures("狙击19"),_frame);
				_textureAils=null;
