package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName37 extends SkillBase
	{
		
		
		public function skillName37(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			snow = new MovieClip(_textureAils.getTextures("吸血37"),_frame);
			_textureAils=null;
