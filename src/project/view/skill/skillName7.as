package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName7 extends SkillBase
	{
		
		
		public function skillName7(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			var snow:MovieClip;
				...
				snow = new MovieClip(_textureAils.getTextures("复仇之魂7_"),_frame);
				_textureAils=null;
