package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName2 extends SkillBase
	{
		
		
		public function skillName2(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			{
				snow = new MovieClip(_textureAils.getTextures("爆裂弹元件 "), Math.random() * _frame+_frame/2);
