package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName34 extends SkillBase
	{
		
		
		public function skillName34(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			{
				snow = new MovieClip(_textureAils.getTextures("天火元件"), Math.random() * _frame+_frame/2);
