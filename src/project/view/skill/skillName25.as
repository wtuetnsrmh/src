package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName25 extends SkillBase
	{
		
		
		public function skillName25(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			var snow:MovieClip;
				...
				snow = new MovieClip(_textureAils.getTextures("魔法反弹25"),_frame);
				_textureAils=null;
