package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName26 extends SkillBase
	{
		
		
		public function skillName26(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			var snow:MovieClip;
				...
				snow = new MovieClip(_textureAils.getTextures("末日审判26"),_frame);
				_textureAils=null;
