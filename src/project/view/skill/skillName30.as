package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName30 extends SkillBase
	{
		
		
		public function skillName30(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			snow = new MovieClip(_textureAils.getTextures("睡眠术30"),_frame);
			_textureAils=null;
