package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName40 extends SkillBase
	{
		
		
		public function skillName40(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			snow = new MovieClip(_textureAils.getTextures("折翼40"),_frame);
			_textureAils=null;
