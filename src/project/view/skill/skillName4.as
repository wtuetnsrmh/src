package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName4 extends SkillBase
	{
		
		
		public function skillName4(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			var snow:MovieClip;
				...
				snow = new MovieClip(_textureAils.getTextures("毒雾1_4"),_frame);
