package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName14 extends SkillBase
	{
		
		
		public function skillName14(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			if(statue!=-1){
				snow = new MovieClip(_textureAils.getTextures("火球14_"+statue+" "),_frame);
				_textureAils=null;
				}
