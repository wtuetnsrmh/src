package project.view.skill
{
	 ...
	 * @author bbjxl
	 */
	public class skillName29 extends SkillBase
	{
		
		
		public function skillName29(id:int,rootContainer:DisplayObjectContainer, judgger:Juggler, frame:int = 60, callBack:Function = null,statue:int=-1)
		{
		...
		private function creaSkillEffect():void
		{
			...
			snow = new MovieClip(_textureAils.getTextures("圣光技能29"),_frame);
			_textureAils=null;
