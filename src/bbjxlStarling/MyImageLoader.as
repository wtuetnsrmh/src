/*
修改默认没有mipmap
增加宽高，防止不是2的幂次尺寸时宽高不对
*/
package bbjxlStarling
{
	 ...
	 * this.addChild( loader );</listing>
	 */
	public class MyImageLoader extends FeathersControl
	{
		/**
		 * @private
		 */
		...
		protected function refreshCurrentTexture():void
		{
			...
			if(_width!=0){
				this._currentTexture = Texture.fromTexture(newTexture, new Rectangle(0, 0, _width,_height));
			}else{
...
//			this._currentTexture = newTexture;
		...
		{
			this._texture=Texture.fromAtfData(rawData,1,false);//关闭mipmap
